...
//     Creacion: 02-Jun-1999  07:07:13
//     Revision: 03-Feb-2002  09:04:02
//
//--------------------------------------------------------------------------
...
class java805 extends JFrame implements ActionListener {
  JLabel texto;
  JLabel pulsado;
  JButton boton;
  JButton botonClick;
  ...
  public void actionPerformed( ActionEvent evt ) {
    ...
    try {
      ...
      // Se crea el canal de de salida conectado a ese fichero, en este caso
      // como fichero de acceso aleatorio y preparado para lectura y para
      // escritura
      RandomAccessFile canalSalida = new RandomAccessFile( fichSalida,"rw" );
      ...
      canalSalida.write( b );
      // Escribimos un carácter de nueva línea, para que las nuevas
      // incorporaciones de texto al fichero se inicien el la línea siguiente
...
//------------------------------------------- Final del fichero java805.java